...
name = 'ripltools'
require 'yaml'
require 'syck'; YAML::ENGINE.yamler = 'syck'
...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'ripl-i18n',          '>= 0.2.3'
